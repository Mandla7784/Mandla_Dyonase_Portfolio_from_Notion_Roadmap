...
function getBotReply(userText: string): string {
  ...
  if (/\b(hi|hello|hey|howdy)\b/.test(t)) return "Hi! I'm Mandla's assistant. Ask me about his projects, skills, or how to get in touch.";
  if (/\b(project|work|portfolio|vercel)\b/.test(t)) return "Mandla has several projects on Vercel — support tickets, learning platform, games, and more. Scroll to the Projects section or click 'View projects' below!";
  if (/\b(skill|tech|stack|experience)\b/.test(t)) return "He works with JavaScript, Next.js, TypeScript, and more. Check the Skills and Experience sections for the full picture.";
  if (/\b(contact|email|hire|message|reach)\b/.test(t)) return "You can reach him via the Contact section — use the form or the email/LinkedIn/GitHub links. He's open to opportunities!";
  if (/\b(who|about|mandla)\b/.test(t)) return "Mandla is a web developer. He's done a Cloud Engineer internship at BCX and builds full-stack and front-end projects. Have a look around the site!";
...
const initialMessages: Message[] = [
  { id: WELCOME_ID, role: "bot", text: "Hi! I'm Mandla. Ask me about my projects, skills, or how to get in touch — or type a message below." },
];
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            {/* Messages - scrollable */}
            <div ref={scrollRef} className="p-4 space-y-4 overflow-y-auto flex-1 min-h-0 max-h-[260px]">
              {messages.map((msg) =>
                msg.role === "bot" ? (
